...
import { SPECIALTIES, User } from "../../types";
				...
				<div className="mt-6">
					<div className="flex flex-col gap-3">
						<GoogleSignIn
							...
							className="w-full bg-white text-gray-900 border border-gray-300 hover:bg-gray-100 font-medium py-3 px-4 rounded-lg transition-colors"
						/>
						<PhoneSignIn
							onSuccess={(user: FirebaseUser) => {
								localStorage.setItem(
								...
								showToast(
									"Successfully registered with phone",
									"success"
								);
								window.location.reload();
							}}
							onError={(error: Error) =>
								showToast(
									error.message || "Phone sign-up failed",
									"error"
								)
							}
							className="w-full"
