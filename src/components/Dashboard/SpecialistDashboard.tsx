        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-400">{user.specialty} Specialist</p>
            </div>
          </div>
      ...
      <div className="p-4 space-y-6">
        ...
        <div className="bg-blue-900/20 border border-blue-500/30 rounded-lg p-4">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="font-medium text-blue-400">Notifications: 3 new consultations</span>
          </div>
        ...
        <div className="space-y-4">
          ...
          {filteredConsultations
            ...
            <div key={consultation.id} className={`bg-gray-800 border rounded-lg p-4 ${getPriorityColor(consultation.priority)}`}>
              ...
              <h4 className="font-medium text-white mb-2">{consultation.title}</h4>
              <p className="text-gray-300 text-sm mb-4 leading-relaxed">{consultation.description}</p>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          >
            <div className="flex items-center gap-3 mb-2">
              ...
              <span className="font-medium">Medical References</span>
            </div>
            <p className="text-sm text-gray-400">Quick access to protocols and guidelines</p>
          </button>
          ...
          >
            ...
            <p className="text-sm text-gray-400">View your previous consultations</p>
          </button>
        </div>
      </div>
    </div>
